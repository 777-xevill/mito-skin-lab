...
<header class="header">
  <div class="wrap header__inner">
    <a class="brand" href="index.html">
      <img class="brand__logo" src="assets/logo/mito-logo.png" alt="Mito Skin Lab — Aesthetic Clinic">
    </a>
...
<div class="mobile-nav" id="mobileNav" data-open="false">
  <div class="mobile-nav__head">
    <a class="brand" href="index.html"><img class="brand__logo" src="assets/logo/mito-logo.png" alt="Mito Skin Lab"></a>
...
<footer class="footer">
  <div class="wrap footer__grid">
    <div class="footer__brand">
      <a class="brand" href="index.html">
        <img class="brand__logo" src="assets/logo/mito-logo-white.png" alt="Mito Skin Lab — Aesthetic Clinic">
      </a>
